...
exports.getColor = exports.GRID_COLORS = exports.PingbackContext = void 0;
...
var Container = function (props) {
    return props.href ? react_1.default.createElement("a", __assign({}, props)) : react_1.default.createElement("div", __assign({}, props));
};
...
var noop = function () { };
var Gif = function (_a) {
    var gif = _a.gif, width = _a.width, forcedHeight = _a.height, _b = _a.onGifRightClick, onGifRightClick = _b === void 0 ? noop : _b, className = _a.className, _c = _a.onGifClick, onGifClick = _c === void 0 ? noop : _c, _d = _a.onGifSeen, onGifSeen = _d === void 0 ? noop : _d, _e = _a.onGifVisible, onGifVisible = _e === void 0 ? noop : _e, _f = _a.user, user = _f === void 0 ? {} : _f, backgroundColor = _a.backgroundColor, overlay = _a.overlay, _g = _a.hideAttribution, hideAttribution = _g === void 0 ? false : _g, _h = _a.noLink, noLink = _h === void 0 ? false : _h, style = _a.style;
    // only fire seen once per gif id
    var _j = react_1.useState(false), hasFiredSeen = _j[0], setHasFiredSeen = _j[1];
    // hovered is for the gif overlay
    var _k = react_1.useState(false), isHovered = _k[0], setHovered = _k[1];
    // only show the gif if it's on the screen
    // if we can't use the dom (SSR), then we show the gif by default
    var _l = react_1.useState(!canUseDOM), showGif = _l[0], setShowGif = _l[1];
    ...
    // custom pingback
    var attributes = react_1.useContext(exports.PingbackContext).attributes;
    // user's overlay
    var Overlay = overlay;
    ...
    return (react_1.default.createElement(Container, { href: noLink ? undefined : gif.url, style: __assign({ width: width,
            height: height }, style), className: emotion_1.cx(Gif.className, gifCss, className), onMouseOver: onMouseOver, onMouseLeave: onMouseLeave, onClick: onClick, onContextMenu: function (e) { return onGifRightClick(gif, e); } },
