    ...
    Carousel.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: containerCss },
            gifs.map(function (gif) {
                ...
                return (react_1.default.createElement(gif_1.default, { className: gifCss, gif: gif, key: gif.id, width: gifWidth, onGifClick: onGifClick, onGifSeen: onGifSeen, onGifVisible: onGifVisible, onGifRightClick: onGifRightClick, user: user, overlay: overlay, hideAttribution: hideAttribution, noLink: noLink }));
            }),
